...
class OrderPage extends StatelessWidget{
  List<OrderItems> orderItems = [
    ...
    OrderItems(number: "2", text: "Pizza & Pasta", secondaryText: "270ml | 134 kcal", amount: "13.81"),
    OrderItems(number: "3", text: "Sweet lemonade", secondaryText: "220ml | 384 kcal", amount: "12.48"),
  ];
  @override
               ...
               children: <Widget>[
                 ...
                 Row(
                   ...
                   children: <Widget>[
                     ...
                     Text("\$70.20",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
                   ],
                 ),
                 SizedBox(height: 20,),
                 ...
                 Row(
                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: <Widget>[
                     Text("725 5th ave. \nNY 10024 New York",style: TextStyle(fontSize: 14,color: Colors.grey.shade500,height: 1.5),),
                 ...
                 Row(
                   ...
                   children: <Widget>[
                     ...
                     SizedBox(width: 8,),
                     Text("**** **** ****",style: TextStyle(fontSize: 14,color: Colors.grey.shade500,height: 1.5),),
                     Expanded(
                         child: Text("1420",style: TextStyle(fontSize: 14,color: Colors.grey.shade500),),
                     ),
                     Text("Change",style: TextStyle(fontSize: 14,color: Colors.amber),),
                   ],
                 ),
         ...
         SafeArea(
           child: Align(
             ...
             child: Container(
               ...
               child: FlatButton(
                 onPressed: (){},
                 child: Text("SUMMIT ORDER",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w200),),
                 color: Colors.amber,
